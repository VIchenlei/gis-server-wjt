...
let config = {
  ...
  NeedInformCollectorList: ['setting', 'card', 'map', 'area', 'dept','reader', 'antenna', 'path', 'drivingface', 'drivingface_render', 'dat_drivingface_warning_point', 'rules', 'vehicle_extend', 'staff_extend', 'staff_extend_ck', 'drivingface_vehicle', 'dat_handup_vehicle', 'light', 'lights_binding', 'lights_group', 'geofault', 'reader_path_tof_n','landmark', 'work_face', 'coalface', 'coalface_vehicle', 'area_reader', 'area_persons_dynamic_thre', 'drivingface_ref_point', 'tt_inspection_route_planning', 'device_power', 'light_shape', 'light_rd_spec_process']
}
